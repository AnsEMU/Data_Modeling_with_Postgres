...
#songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (songplay_id SERIAL  PRIMARY KEY, start_time timestamp,userId int NOT NULL,level varchar,song_id varchar,artist_id varchar, sessionId int,location varchar,userAgent varchar);""")
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays(songplay_id SERIAL PRIMARY KEY,start_time BIGINT not null,userId varchar NOT NULL,level varchar not null,song_id varchar ,artist_id varchar,sessionId int not null,location varchar,userAgent varchar);""")
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artists (artist_id varchar PRIMARY KEY, artist_name varchar not null, artist_location varchar, artist_latitude numeric, artist_longitude numeric);""")
...
songplay_table_insert = ("""INSERT INTO songplays (start_time, userId, level, song_id, artist_id, sessionId, location, userAgent) VALUES (%s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT DO NOTHING;""")
